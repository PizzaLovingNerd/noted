...
export const fetchTrendingAlbums = async (): Promise<Album[]> => {
  return fetchSpecificAlbums([
    ...
    },
    {
      ...
      fallback: "Bad Bunny",
      forcedTitle: "DeBÍ TiRAR MáS FOToS",
      forcedArtist: "Bad Bunny",
      forcedDate: "2025-01-05",
      forcedGenre: "Latin",
      forcedArtwork: TRENDING_ARTWORK.BadBunny,
    },
  ]);
};
